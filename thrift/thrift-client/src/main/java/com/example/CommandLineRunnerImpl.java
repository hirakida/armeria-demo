...
public class CommandLineRunnerImpl implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        HelloService.Iface client1 = buildHelloClient("tbinary");
        String response1 = client1.hello1("tbinary");
        log.info("{}", response1);
        HelloResponse response2 = client1.hello2(new HelloRequest("hirakida"));
        log.info("{}", response2);

        HelloService.Iface client2 = buildHelloClient("tcompact");
        log.info("{}", client2.hello1("tcompact"));

        HelloService.Iface client3 = buildHelloClient("tjson");
        log.info("{}", client3.hello1("tjson"));

        HelloService.Iface client4 = buildHelloClient("ttext");
